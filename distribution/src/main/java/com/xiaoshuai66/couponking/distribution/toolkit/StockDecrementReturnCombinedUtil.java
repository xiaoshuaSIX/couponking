...
/**
 * @ClassName: StockDecrementReturnCombinedUtil.java
 * @Description: 用户优惠券执行 LUA 脚本返回数据 | 通过位移形式提高性能，是个小优化
 * 因为预计没 5000 条记录保存一次数据库，2 ^ 12 能标识 4096，所以这里采用了 2 ^ 13
 *
 * @author 赵帅
 * @Create 2025/2/20 15:22
 */
public class StockDecrementReturnCombinedUtil {

    /**
     * 2^13 > 5000，所以采用 13 位来表示第二个字段
     */
