...
import com.xiaoshuai66.couponking.merchant.admin.service.handler.filter.CouponTemplateCreateParamBaseVerifyChainFilter;
import com.xiaoshuai66.couponking.merchant.admin.service.handler.filter.CouponTemplateCreateParamNotNullChainFilter;
import com.xiaoshuai66.couponking.merchant.admin.service.handler.filter.CouponTemplateCreateParamVerifyChainFilter;
...
/**
 * ClassName: MerchantAdminChainContext
 * Package: com.xiaoshuai66.couponking.merchant.admin.service.basics.chain
 * Description: 商家后台责任链上下文容器
...
public class MerchantAdminChainContext<T> implements ApplicationContextAware, CommandLineRunner {
    ...
    public void handler(String mark, T requestParam) {
        // 根据 mark 表示从责任链容器中获取一组责任链实现 Bean 集合
