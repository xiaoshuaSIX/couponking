package com.xiaoshuai66.couponking.merchant.admin.common.log;
...
/**
 * ClassName: CommonEnumParseFunction
 * Package: com.xiaoshuai66.couponking.merchant.admin.common.log
 * Description: 操作日志组件解析枚举类对应的描述信息
 *
 * @Author 赵帅
 * @Create 2025/2/12 14:48
 * @Version 1.0
 */
@Component
public class CommonEnumParseFunction implements IParseFunction {
    ...
    private String findEnumValueByName(String enumClassname, int enumValue) {
        if (DISCOUNT_TARGET_ENUM_NAME.equals(enumClassname)) {
            ...
            throw new IllegalArgumentException("未知的枚举类类名: " + enumClassname);
        }
    }
}
